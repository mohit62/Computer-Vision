...
checkpointer = ModelCheckpoint(filepath='bestmodel2.h5', verbose=1, save_best_only=True)
model.fit(train_blur, train_sharp,batch_size=8, epochs=30,shuffle=True,validation_split=0.2,callbacks=[checkpointer])
model.save("blur_model2.h5")
